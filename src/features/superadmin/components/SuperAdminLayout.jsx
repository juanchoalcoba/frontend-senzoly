...
import { 
  ...
  BarChart3, Settings, ShieldAlert, LogOut, Menu, X
} from 'lucide-react';
...
export default function SuperAdminLayout() {
  ...
  const navItems = [
    ...
    { name: 'Suscripciones', icon: CreditCard, path: '/super-admin/subscriptions' },
    ...
    <div className="min-h-screen bg-slate-50 flex">
      ...
      `}>
        ...
        <div className="h-20 flex items-center justify-between px-6 border-b border-slate-800">
          <img src="/logotipo.png" alt="Senzoly" className="h-8 brightness-0 invert opacity-90" />
